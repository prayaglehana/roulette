...
function mousePressed() {
    if (bet_no>0) {
      console.log(bet_no);
      roulette.get_number(bet_no,{from: web3.eth.accounts[1], gas:1000000}); 
    } else {
      console.log(bet_no);
    }
  }